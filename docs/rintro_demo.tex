...
\pandocbounded{\includegraphics[keepaspectratio]{rintro_demo_files/figure-latex/unnamed-chunk-183-1.pdf}}
...
\section{9.5 The Real Power of the ggplot package - Customisation}\label{the-real-power-of-the-ggplot-package---customisation}
...
\section{9.7 Faceting}\label{faceting}
...
\section{9.8 Combining Charts}\label{combining-charts}
...
\section{9.9 Violin Charts}\label{violin-charts}

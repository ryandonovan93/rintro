...
In this weeks workshop, we are going to learn how to perform both simple and multiple regressions, both of which you covered in the week 5 lecture.

-   Conduct a linear regression

-   Conduct a multiple regression

-   Check your assumptions for both approaces

-   Create graphs to visualise your results.
...
**H0:** Budget will not significantly predict revenue.
...
By inspecting our data we can see that each score for our revenue data comes from a different participant/observation.

*d. The relationship between outcome and predictor is linear*

We will inspect this momentarily. But this assumption states that the relationship can be accurately described a straight line.

*e. The residuals should be normally distributed*

This is similar to our normality distribution. Residuals here mean that rather than looking at the distribution of your predictor variables, or your outcome variables, you look at the difference between your predicted scores (based on our regression model) and our actual scores. These differences should form a normal distribution.

*f. The assumption of homoscedasticity.*

Same as we encountered in correlation, points should have uniform variance across difference points of our predictors and outcome variable.

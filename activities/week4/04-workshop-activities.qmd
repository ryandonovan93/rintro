...
pwr.t.test(d = 0.5,         # Your Expected effect size
           ...
           alternative = "two.sided")  # Indicates a two-tailed test, can be changed to a one-tailed test by either using the term "less" (if group 1 is predicted to score less than group 2) or "greater" (if group 2 is predicted to score greater than group 1)
...
pwr.t.test(d = 0.5,         # Your Expected effect size
           ...
           alternative = "two.sided")  # Indicates a two-tailed test, #can be changed to "less" (if group 1 is predicted to score less than group 2) or "greater" (if group 2 is predicted to score greater than group 1)

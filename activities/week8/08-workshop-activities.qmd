...
We can see that our power is 0.37 (37%), which suggests it is substantially underpowered (we want it to be 80% or higher). Therefore we need to be extra cautious when interpreting these results.
...
The main thing, is that when you are adapting this code for your own work (e.g. in the exercise later), make sure to replace wherever you see `Treatment` with your Independent Variable, and where ever you see `Neuroticism` with your Dependent Variable.

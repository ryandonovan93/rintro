...
First, create your week10 folder and set it as your working directory.
...
Second, we are going to create our ***first R script*** for today. We will be creating more than one. Call your first script `10-data-wrangling-p1`
...
### Download this file onto your computer and move it to your `week10` folder.

Once this is done load the dataset into R and save it as a dataframes called "df_flanker_raw":
...
## Activity 4: Inspect your Dataset
...
| status | Whether the person was in the experiment or the control group |

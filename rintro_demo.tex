...
It's good practice to set your working directory when you first open RStudio. Remember that the working directory is the location where R will look or store files by default. Last week I showed you how to set the Working Directory using \hyperref[set_wd]{a button-and-click interface}.

\pandocbounded{\includegraphics[keepaspectratio]{img/gifs/set_up_working_directory.gif}}

Using those instructions, create a folder called ``Week2'' in the \texttt{rintro} project folder for this class, and set it as your working directory.

Your output should be similar to mine.

\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}} \FunctionTok{setwd}\NormalTok{(}\StringTok{"C:/Users/0131045s/Desktop/PS6183/rintro/week2"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"C:/Users/0131045s/Desktop/PS6183/rintro/week2"}
\end{Highlighting}
\end{Shaded}
...
\item
  If I type the following code, then I get the \texttt{+} operator, how can I fix it? Run the code yourself and test your answer.
\end{enumerate}
...
\item
  Print the values of \texttt{height\_cm} and \texttt{height\_m.}
\end{enumerate}
...
\caption{\label{fig:unnamed-chunk-68}Indexing for Numeric Vector}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{img/03-index-character.png}}
\caption{\label{fig:unnamed-chunk-69}Indexing for Character Vector}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{img/03-index-logical.png}}
\caption{\label{fig:unnamed-chunk-70}Indexing for Logical Vector}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-83}Vectors can visually conceptualised as a column or row of data.}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-84}The relationship between data frames and vectors. The different colours in the data frame indicate they are composed of independent vectors}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vect1 }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"No, not this element"}\NormalTok{, }\StringTok{"Yes, this element"}\NormalTok{, }\StringTok{"No, not this element"}\NormalTok{, }\StringTok{"Yes, this element"}\NormalTok{, }\StringTok{"No, not this element"}\NormalTok{, }\StringTok{"Yes, this element"}\NormalTok{)}

...
[^04-programming-p2-1]: There are some important exceptions. If you are creating R projects (like we did and which I would recommend going forward) ticking the renv option (see option 1), this basically partitions your R project into its own little self-contained space on your computer where it will operate. So when you download and install R packages in that project, they will only exist in that location on your computer (i.e. your project). Now once you are working in that project, then you won't need to install them over and over again.
    ...
    Similarly, in posit cloud, every new R project you make will be self-contained, so you will need to install the packages again.
